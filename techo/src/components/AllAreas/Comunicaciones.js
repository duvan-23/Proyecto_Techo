        ...
        <Container style={{position: 'relative'}}>
          <Row style={{margin: '50px 0px 0px 0px'}}>
            <Col md={12} className="m justify-content-md-center fluid margen archivos2 mb-5" onMouseEnter={() => $('#boton2').removeClass("ocultar2")} onMouseLeave={() => $('#boton2').addClass("ocultar2")}>
              <Iframe  className="archivos"src="https://drive.google.com/embeddedfolderview?id=1da1Q7m9eqkWiv03BhAyDn8tT0Jm0BXNQ#grid" style={{color: 'white !important'}} width="100%" height="310" frameborder="0"  scrolling="si"></Iframe>
                <a rel="noopener noreferrer" target="_blank" href="https://drive.google.com/drive/folders/1da1Q7m9eqkWiv03BhAyDn8tT0Jm0BXNQ?usp=sharing" className="ocultar2 enlace2" id="boton2"><FontAwesomeIcon className="icono" icon={faExternalLink} /></a>
            </Col>
          </Row>  
        </Container> 
    </>
