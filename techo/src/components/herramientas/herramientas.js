      ...
      <Container style={{position: 'relative'}}>
        <Row style={{margin: '50px 0px 0px 0px'}}>
          <Col md={12} className="m justify-content-md-center fluid margen" onMouseEnter={() => $('#boton').removeClass("ocultar")} onMouseLeave={() => $('#boton').addClass("ocultar")}>
            <Iframe  src="https://calendar.google.com/calendar/embed?height=600&wkst=2&bgcolor=%230092dd&ctz=America%2FMontevideo&title=Calendario%20Institucional&src=YWRtaW5pc3RyYWNpb24udXJ1Z3VheUB0ZWNoby5vcmc&color=%23039BE5"  width="100%" height="600px" frameborder="0" scrolling="no" title="myFrame" className="calendar"></Iframe>
            <a rel="noopener noreferrer" target="_blank" href="https://calendar.google.com/calendar/embed?height=600&wkst=2&bgcolor=%230092dd&ctz=America%2FMontevideo&title=Calendario%20Institucional&src=YWRtaW5pc3RyYWNpb24udXJ1Z3VheUB0ZWNoby5vcmc&color=%23039BE5" className="ocultar enlace"  id="boton"><FontAwesomeIcon className="icono" icon={faExternalLink} /></a>
          </Col>
